...
namespace Shooter
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        // The sound that is played when a laser is fire
        ...
        private void UpdatePlayer(GameTime gameTime)
        {
            ...
            player.Position.Y = MathHelper.Clamp(player.Position.Y, 100, (GraphicsDevice.Viewport.Height -100)- player.Height);
